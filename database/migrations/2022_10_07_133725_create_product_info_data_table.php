...
return new class extends Migration
{
    ...
    {
        Schema::create('product_info_data', function (Blueprint $table) {
            $table->id();
        ...
        $data = MigrateService::createTable02(
            'product_info_data',
            'product_info_data',
            ['is_multiple_language' => 1, 'table_data' => 'product_info_data', 'parent_id' => 0, 'type_show' => 5, 'is_edit' => 0]
        );
    ...
    {
        Schema::dropIfExists('product_info_data');
    }
};
