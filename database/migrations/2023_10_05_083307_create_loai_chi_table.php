...
return new class extends Migration
{
    ...
    {
        Schema::create('loai_chi', function (Blueprint $table) {
            $table->id();
        ...
        $tbl = Table::where('name', 'loai_chi')->first();
        $order_col = 1;
        
         MigrateService::createColumn02($tbl->id, 'id', 'id', 'INT', 'number', $order_col++);
         MigrateService::createColumn02($tbl->id, 'name', 'Loại chi', 'VARCHAR', 'text', $order_col++, 
