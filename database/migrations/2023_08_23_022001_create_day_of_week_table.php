...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $tbl = Table::where('name', 'day_of_week')->first();
        $tableId = $tbl->id;
        $order_col = 1;
        MigrateService::createColumn02($tableId, 'id', 'id', 'INT', 'number', $order_col++, ['edit' => 0]);
        MigrateService::createColumn02($tableId, 'name', 'Ngày trong tuần', 'VARCHAR', 'text', $order_col++, ['show_in_list'=> 1,'require' => 1,'is_view_detail' => 1]);
