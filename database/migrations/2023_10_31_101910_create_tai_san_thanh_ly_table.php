...
return new class extends Migration
{
    ...
    {
        Schema::create('tai_san_thanh_ly', function (Blueprint $table) {
            $table->id();
            $table->string('name')->nullable();
            $table->string('tai_san_id')->nullable();
            $table->date('ngay_thanh_ly')->nullable();
        ...
        Table::create([
            //require
            'name' => 'tai_san_thanh_ly',
            'display_name' => 'Thanh lý tài sản',
            'parent_id' => 0,
            'sort_order' => 0,
        ...
        $tbl = Table::where('name', 'tai_san_thanh_ly')->first();
        $order_col = 1;
    ...
    {
        Schema::dropIfExists('tai_san_thanh_ly');
    }
};
