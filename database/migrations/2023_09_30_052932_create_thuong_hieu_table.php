...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $tbl = MigrateService::createTable02( 'thuong_hieu', 'Nhóm hàng hóa',  $config);
        
        MigrateService::createColumn02($tbl->id, 'code', 'Mã nhóm', 'VARCHAR', 'text', $order_col++,['auto_generate_code' => '{"edit":0, "prefix":"NH", "length":5}']);
        MigrateService::createColumn02($tbl->id, 'name', 'Tên Nhóm hàng hóa', 'VARCHAR', 'text', $order_col++,['require' => 1,'is_view_detail' => 1,'add2search' => 1,'show_in_list' => 1]);
