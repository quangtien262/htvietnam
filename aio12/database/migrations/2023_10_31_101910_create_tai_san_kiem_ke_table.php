...
return new class extends Migration
{
    ...
    {
        Schema::create('tai_san_kiem_ke', function (Blueprint $table) {
            $table->id();
            $table->string('name')->nullable();
            $table->string('tai_san_id')->nullable();
            $table->date('ngay_kiem_ke')->nullable();
        ...
        Table::create([
            //require
            'name' => 'tai_san_kiem_ke',
            'display_name' => 'Kiểm kê tài sản',
            'parent_id' => 0,
            'sort_order' => 0,
        ...
        $tbl = Table::where('name', 'tai_san_kiem_ke')->first();
        $order_col = 1;
    ...
    {
        Schema::dropIfExists('tai_san_kiem_ke');
    }
};
