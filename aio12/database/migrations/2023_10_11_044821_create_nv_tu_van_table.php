...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $tbl = Table::where('name', 'nv_tu_van')->first();
        $tableId = $tbl->id;
        $order_col = 1;
        ...
        $ma = Table::where('name', 'admin_users')->first();
        MigrateService::createColumn02($tableId, 'admin_users_id', 'Mã nhân viên', 'VARCHAR', 'select', $order_col++, ['select_table_id' => $ma->id,  'show_in_list' => 1, 'is_view_detail' => 1]);
        MigrateService::createColumn02($tableId, 'name', 'Tiền chiết khấu', 'INT', 'number', $order_col++, ['require' => 1,'show_in_list' => 1]);
        MigrateService::createColumn02($tableId, 'phan_tram_chiet_khau', 'Chiết khấu (%)', 'INT', 'number', $order_col++, ['show_in_list' => 1]);
