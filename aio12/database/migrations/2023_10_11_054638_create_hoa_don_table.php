    ...
    return new class extends Migration
    {
        ...
        public function up(): void
        {
            Schema::create('hoa_don', function (Blueprint $table) {
                ...
                $table->integer('dat_lich_id')->nullable();
            ...
            $lichHen = Table::where('name', 'dat_lich')->first();
            MigrateService::createColumn02($tableId, 'dat_lich_id', 'Lịch hẹn', 'INT', 'select', $order_col++, 
