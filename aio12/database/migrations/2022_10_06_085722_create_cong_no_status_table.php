 <?php
    ...
    return new class extends Migration
    {
        ...
        {
            Schema::create('cong_no_status', function (Blueprint $table) {
                $table->id();
                $table->string('name')->nullable();
                $table->string('color')->nullable();
                $table->string('code_config')->nullable();
            ...
            $tbl = Table::where('name', 'cong_no_status')->first();
            $tableId = $tbl->id;
            $order_col = 1;
        ...
        {
            Schema::dropIfExists('cong_no_status');
        }
    };
