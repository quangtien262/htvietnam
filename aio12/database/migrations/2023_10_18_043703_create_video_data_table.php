...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        MigrateService::createColumn02($videosData->id, 'data_id', 'data_id', 'INT', 'number', $order++);
        MigrateService::createColumn02($videosData->id, 'name_data', 'Tiêu đề', 'VARCHAR', 'text', $order++);
        MigrateService::createColumn02($videosData->id, 'name_meta', 'Mô tả ảnh đại diện (alt)', 'TEXT', 'text', $order++);
        ...
        MigrateService::createColumn02($videosData->id, 'updated_at', 'Ngày tạo', 'DATETIME', 'date', $order++, ['edit' => 0]);
    }
