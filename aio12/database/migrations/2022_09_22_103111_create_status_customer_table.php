...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $tbl = Table::where('name', 'customer_status')->first();
        $tableId = $tbl->id;
        $order_col = 1;
        MigrateService::createColumn02($tableId, 'id', 'id', 'INT', 'number', $order_col++,['edit' => 0]);
        MigrateService::createColumn02($tableId, 'name', 'Trạng thái khách hàng ', 'VARCHAR', 'text', $order_col++,['require' => 1,'is_view_detail' => 1,'add2search' => 1,'show_in_list' => 1]);
        MigrateService::createColumn02($tableId, 'description', 'Mô tả ngắn', 'TEXT', 'textarea', $order_col++);
        MigrateService::createColumn02($tableId, 'create_by', 'Người tạo', 'VARCHAR', 'select', $order_col++, ['edit' => 0, 'select_table_id' => $tbl->id]);
