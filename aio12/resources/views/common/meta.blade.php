...
<link data-n-head="ssr" rel="alternate" hreflang="en" href="https://{{ $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] }}">
...
<meta name="description" content="{{ !empty($seo['description']) ? $seo['description'] : $config->meta_description }}"/>
...
<meta property="twitter:image" data-n-head="ssr" content="{{ $seo['avatar'] ?? $banner }}?v={{ config('app.version') }}">
...
<meta property="og:description" content="{{ $seo['description'] ?? $config->meta_description }}" itemprop="description"/>
...
<meta property="twitter:url" data-n-head="ssr" content="https://{{ $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] }}"/>
...
<link rel="icon" type="image/x-icon" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/114.png?v={{ config('app.version') }}"/>
<link rel="shotcut" type="image/x-icon" href="{{ $config->logo }}?v={{ config('app.version') }}"/>
<link rel="image_src" type="image/jpeg" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/114.png?v={{ config('app.version') }}"/>

<!-- iPad icons -->
<link rel="apple-touch-icon-precomposed" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/1.png?v={{ config('app.version') }}" sizes="72x72">
<link rel="apple-touch-icon-precomposed" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/114.png?v={{ config('app.version') }}" sizes="144x144">
<!-- iPhone and iPod touch icons -->
<link rel="apple-touch-icon-precomposed" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/57.png?v={{ config('app.version') }}" sizes="57x57">
<link rel="apple-touch-icon-precomposed" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/114.png?v={{ config('app.version') }}" sizes="114x114">
<!-- Nokia Symbian -->
...
<link data-n-head="ssr" rel="apple-touch-icon" sizes="180x180" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/114.png">
...
<link data-n-head="ssr" rel="icon" type="image/png" sizes="16x16" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/57.png">
<link data-n-head="ssr" rel="icon" type="image/png" sizes="32x32" href="https://{{ $_SERVER['SERVER_NAME'] }}/logo/57.png">
