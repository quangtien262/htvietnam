    ...
    <section class="section footer-section dark" id="section_1707019293">
        ...
        <div class="section-content relative">
            <div class="row" id="row-313125092">
                ...
                <div id="col-1994144840" class="col medium-12 small-12 large-4 col-sm-12">
                    <div class="col-inner">
                    ...
                    <div class="social-icons follow-icons full-width text-left">
                        ...
                        <a href="https://facebook.com/{{ $config->facebook_id }}" target="_blank" data-label="Facebook"
                        ...
                        <a href="{{ $config->instagram }}" target="_blank" rel="noopener noreferrer nofollow"
                            ...
                            title="Follow on Instagram" aria-label="Follow on Instagram"><i class="icon-instagram"></i>
                        </a>
                        @endif
                        ...
                        <a href="{{ $config->youtube }}" target="_blank" rel="noopener noreferrer nofollow"
                            ...
                            title="Follow on YouTube" aria-label="Follow on YouTube"><i class="icon-youtube"></i>
                        </a>
                        @endif
                        ...
                        <a href="{{ $config->tiktok }}" target="_blank" rel="noopener noreferrer nofollow"
                            ...
                            title="Follow on TikTok" aria-label="Follow on TikTok"><i class="icon-tiktok"></i>
                        </a>
                        @endif
                        ...
                        <a href="{{ $config->pinterest }}" target="_blank" rel="noopener noreferrer nofollow"
                            ...
                            title="Follow on Pinterest" aria-label="Follow on Pinterest"><i class="icon-pinterest"></i>
                        </a>
                        @endif
                    </div>
                </div>
        ...
        <div class="container clearfix">
            <div class="footer-primary pull-left">
                <div class="copyright-footer">
                    {!! !empty($config->copyright) ? $config->copyright : '' !!}
                </div>
            </div>
        </div>
    </div>
