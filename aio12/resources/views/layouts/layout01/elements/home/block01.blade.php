            ...
            <div class="col-inner">
               <div class="icon-box featured-box icon-box-center text-center">
                     ...
                     <div class="icon">
                        <div class="icon-inner">
                           ...
                           <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                              ...
                              <g>
                                 <path
                                    d="M413.959,130.672c-28.105,0-50.974-22.869-50.974-50.979c0-28.112,22.868-50.979,50.974-50.979
                  ...
                  <div class="icon-box-text last-reset">
                     ...
                     <p style="text-align: center;">Mauris interdum mauris eget magna scelerisque pretium. Praesent sit
                        amet ultricies tellus, vel tempor ante.</p>
            ...
            <div class="col-inner">
               <div class="icon-box featured-box icon-box-center text-center">
                  ...
                  <div class="icon-box-text last-reset">
                     ...
                     <p style="text-align: center;">Cras eget turpis fermentum, pulvinar justo in, sollicitudin risus.
                        Suspendisse vehicula preti semper. Aenean convallis eu neque</p>
                     <a class="button primary lowercase nut-xem-them">
                        <span>Xem thêm</span>
                     </a>
                  </div>
            ...
            <div class="col-inner">
               <div class="icon-box featured-box icon-box-center text-center">
                           ...
                           <svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1"
                              ...
                              <g>
                                 <g>
                                    <g>
                                       <path
                                          d="M99.105,31.353c-37.358,0-67.75,30.393-67.75,67.75s30.393,67.75,67.75,67.75c37.357,0,67.75-30.393,67.75-67.75
                  ...
                  <div class="icon-box-text last-reset">
                     ...
                     <p style="text-align: center;">Morbi sit amet est vitae urna mollis posuere. Proin tincidunt,
                        libero nec porta aliquet, lacus quam pulvinar ex.</p>
                     <a class="button primary lowercase nut-xem-them">
                        <span>Xem thêm</span>
                     </a>
                  </div>
