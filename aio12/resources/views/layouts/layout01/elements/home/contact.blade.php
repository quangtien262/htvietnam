                ...
                <div id="col-1544171652" class="col cot3 small-12 large-12">
                    <div class="col-inner">
                        ...
                        <div class="wpcf7 no-js" id="wpcf7-f563-p2-o1" lang="vi" dir="ltr">
                            ...
                            {{-- <form action="{{ route('contact') }}" method="post" class="wpcf7-form init" aria-label="Contact form" data-status="init"> --}}
                            @csrf
                            <div class="form-lien-he row">
                                ...
                                <div class="col large-6">
                                    <p>
                                        <span class="wpcf7-form-control-wrap" data-name="email-745">
                                            <select class="wpcf7-form-control wpcf7-text" name="contact[area]">
    ...
    <script>
        function sendContact(formID, btn) {
            ...
            $jq.ajax({
                ...
                data: $jq(formID + " input, " + formID + " textarea").serialize(), //only input
                success: function(response) {
                    $jq(btn).html('Gửi liên hệ');
                    ...
                    if (response.status_code === 200) {
                        ...
                        $jq(formID + ' .contact_name').val('');
                        $jq(formID + ' .contact_phone').val('');
                        $jq(formID + ' .contact_email').val('');
                        $jq(formID + ' .contact_content').val('');

                        $jq(formID + ' .result').text(
                            'Gửi yêu cầu thành công, cảm ơn bạn đã gửi liên hệ cho chúng tôi, Chúng tôi sẽ liên hệ lại với bạn trong vòng 24h!'
                        )
                    }
                },
        ...
        function validatonFormContact(formID) {
            $jq(formID + '  .name_error').text('');
            $jq(formID + '  .email_error').text('');
            $jq(formID + '  .phone_error').text('');
            $jq(formID + '  .content_error').text('');
