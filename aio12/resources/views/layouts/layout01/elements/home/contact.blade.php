                           ...
                           <div class="icon-box-img" style="width: 40px">
                              <div class="icon">
                                 <div class="icon-inner">
                                    <svg width="800px" height="800px" viewBox="0 0 1024 1024" fill="#000000"
                     ...
                     <div class="form-lien-he row">
                           ...
                           <p>
                              <span class="wpcf7-form-control-wrap" data-name="text-981">
                                 <input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                    aria-required="true" aria-invalid="false" placeholder="Enter your name" value=""
                                    type="text" name="text-981" />
                              </span>
                           </p>
                        </div>
                        <div class="col large-6">
                           <p>
                              <span class="wpcf7-form-control-wrap" data-name="email-745">
                                 <input size="40"
                                    ...
                                    aria-invalid="false" placeholder="Enter your email..." value="" type="email"
                                    name="email-745" />
                              </span>
                           </p>
                        </div>
                        <div class="col large-12">
                           <p><span class="wpcf7-form-control-wrap" data-name="text-984"><input size="40"
                              ...
                              <span class="wpcf7-form-control-wrap" data-name="textarea-680"><textarea cols="40"
                                    rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false"
                                    placeholder="Enter your message" name="textarea-680"></textarea></span><br />
