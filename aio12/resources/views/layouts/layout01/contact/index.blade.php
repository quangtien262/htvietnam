...
@section('content')
    ...
    <div id="content" role="main" class="content-area">
        <section class="section dau-trang-section dark has-parallax" id="section_386067057">
            ...
            <div class="section-content relative">
                <div class="row align-middle" id="row-1780672503">
            ...
            <style>
                ...
                #section_386067057 .section-bg-overlay {
                ...
                #section_386067057 .ux-shape-divider--bottom svg {
                    height: 150px;
                    --divider-width: 100%;
                }
            </style>
        </section>
        <section class="section section8" id="section_1145803677">
            <div class="bg section-bg fill bg-fill bg-loaded">
            </div>
            <div class="section-content relative">
                <div class="row" id="row-376558233">
                    <div id="col-1759376568" class="col small-12 large-12">
                        <div class="col-inner">
                            <div class="tieu-de">
                                <p style="text-align: center;">CONNECT WITH US</p>
                                <h2 style="text-align: center;">OUR CONTACTS</h2>
                            </div>
                            <p style="text-align: center;"><span style="color: #808080; font-size: 95%;"><em>Lorem ipsum
                                        dolor sit amet, consectetur adipiscing elit. Praesent dapibus erat in tincidunt
                                        consequat. Phasellus sit amet<br>
                                        convallis turpis, molestie nunc. Nulla facilisi. Vestibulum aliquam convallis
                                        ligula.</em></span>
                            </p>
                        </div>
                    </div>
                    <div id="col-1769411026" class="col cot2 small-12 large-12">
                        <div class="col-inner">
                            <div class="row" id="row-554501497">
                                <div id="col-99448630" class="col medium-4 small-12 large-4">
                                    <div class="col-inner">
                                ...
                                <div id="col-1249347754" class="col medium-4 small-12 large-4">
                                    <div class="col-inner">
                                        <div class="icon-box featured-box icon-box-left text-left">
                                            <div class="icon-box-img" style="width: 40px">
                                                <div class="icon">
                                            ...
                                            <div class="icon-box-text last-reset">
                                                <h3>CALL US</h3>
                                                <p>Support: 0972.939.xxx<br>
                                                    Office: 0800 123 xxxx
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div id="col-541602717" class="col medium-4 small-12 large-4">
                                    <div class="col-inner">
                                        <div class="icon-box featured-box icon-box-left text-left">
                                            <div class="icon-box-img" style="width: 40px">
                                                <div class="icon">
                ...
                <div id="gap-505084396" class="gap-element clearfix" style="display:block; height:auto;">
                    <style>
                        #gap-505084396 {
                            padding-top: 15px;
                        }
                ...
                <div class="row row2" style="max-width:800px" id="row-228263924">
                    <div id="col-128600542" class="col cot3 small-12 large-12">
                        <div class="col-inner">
                            <p style="text-align: center;"><span style="color: #808080;">SHORT LOIN MEATLOAF</span></p>
                            <h2 class="text-uppercase topmargin_5 bottommargin_25" style="text-align: center;">CONTACT FORM
                            </h2>
                            <div class="wpcf7 js" id="wpcf7-f563-p17-o1" lang="vi" dir="ltr">
                                <div class="screen-reader-response">
                                    <p role="status" aria-live="polite" aria-atomic="true"></p>
                                    <ul></ul>
                                </div>
                                <form action="/contact-us/#wpcf7-f563-p17-o1" method="post" class="wpcf7-form init"
                                    aria-label="Contact form" novalidate="novalidate" data-status="init">
                                    <div style="display: none;">
                                        <input type="hidden" name="_wpcf7" value="563">
                                        <input type="hidden" name="_wpcf7_version" value="5.7.3">
                                        <input type="hidden" name="_wpcf7_locale" value="vi">
                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f563-p17-o1">
                                    ...
                                    <div class="form-lien-he row">
                                        ...
                                        <div class="col large-6">
                                            <p><span class="wpcf7-form-control-wrap" data-name="email-745"><input size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-email"
                                                        aria-invalid="false" placeholder="Enter your email..." value=""
                                                        type="email" name="email-745"></span>
                                            </p>
                                        </div>
                                        <div class="col large-12">
                                            <p><span class="wpcf7-form-control-wrap" data-name="text-984"><input size="40"
                                                        class="wpcf7-form-control wpcf7-text" aria-invalid="false"
                                                        placeholder="Enter your subject" value="" type="text"
                                                        name="text-984"></span><br>
                                                <span class="wpcf7-form-control-wrap" data-name="textarea-680"><textarea
                                                        cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea"
                                                        aria-invalid="false" placeholder="Enter your message"
                                                        name="textarea-680"></textarea></span><br>
                                                <input class="wpcf7-form-control has-spinner wpcf7-submit" type="submit"
                                                    value="Send Message"><span class="wpcf7-spinner"></span>
                                            </p>
                                        </div>
                                    </div>
            ...
            <style>
                ...
                #section_1145803677 .ux-shape-divider--top svg {
                    height: 150px;
                    --divider-top-width: 100%;
                }

                #section_1145803677 .ux-shape-divider--bottom svg {
                    height: 150px;
                    --divider-width: 100%;
                }
            </style>
        </section>
        <section class="section section9" id="section_1973989718">
            <div class="bg section-bg fill bg-fill  bg-loaded">
            </div>
            <div class="section-content relative">
                <div class="row align-middle" style="max-width:90%" id="row-1893603724">
                    <div id="col-1565597709" class="col medium-2 small-6 large-2">
                        <div class="col-inner">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_2117829519">
                                <div class="img-inner image-color dark">
                                    <img decoding="async" width="220" height="112"
                                        src="https://solar3.maugiaodien.com/wp-content/uploads/2023/01/1.png"
                    ...
                    <div id="col-1518798139" class="col medium-2 small-6 large-2">
                        <div class="col-inner">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_822962653">
                                <div class="img-inner image-color dark">
                                    <img decoding="async" width="220" height="112"
                                        src="https://solar3.maugiaodien.com/wp-content/uploads/2023/01/2.png"
                                        class="attachment-original size-original" alt="">
                                </div>
                                <style>
                                    #image_822962653 {
                    ...
                    <div id="col-1303668358" class="col medium-2 small-6 large-2">
                        <div class="col-inner">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_989253747">
                                <div class="img-inner image-color dark">
                                    <img loading="lazy" decoding="async" width="220" height="112"
                                        src="https://solar3.maugiaodien.com/wp-content/uploads/2023/01/3.png"
                                        class="attachment-original size-original" alt="">
                                </div>
                                <style>
                                    #image_989253747 {
                    ...
                    <div id="col-481926976" class="col medium-2 small-6 large-2">
                        <div class="col-inner">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1483791953">
                                <div class="img-inner image-color dark">
                                    <img loading="lazy" decoding="async" width="220" height="112"
                                        src="https://solar3.maugiaodien.com/wp-content/uploads/2023/01/4.png"
                                        class="attachment-original size-original" alt="">
                                </div>
                                <style>
                                    #image_1483791953 {
                    ...
                    <div id="col-2030784805" class="col medium-2 small-6 large-2">
                        <div class="col-inner">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1825572753">
                                <div class="img-inner image-color dark">
                                    <img loading="lazy" decoding="async" width="220" height="112"
                                        src="https://solar3.maugiaodien.com/wp-content/uploads/2023/01/5.png"
                                        class="attachment-original size-original" alt="">
                                </div>
                                <style>
                                    #image_1825572753 {
                    ...
                    <div id="col-118627896" class="col medium-2 small-6 large-2">
                        <div class="col-inner">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_620467189">
                                <div class="img-inner image-color dark">
                                    <img loading="lazy" decoding="async" width="220" height="112"
                                        src="https://solar3.maugiaodien.com/wp-content/uploads/2023/01/6.png"
                                        class="attachment-original size-original" alt="">
                                </div>
                                <style>
                                    #image_620467189 {
            ...
            <style>
                ...
                #section_1973989718 .ux-shape-divider--top svg {
                    height: 150px;
                    --divider-top-width: 100%;
                }

                #section_1973989718 .ux-shape-divider--bottom svg {
                    height: 150px;
                    --divider-width: 100%;
                }
            </style>
