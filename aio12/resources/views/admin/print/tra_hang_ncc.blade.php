    ...
    <div class="invoice">
        ...
        <div class="info">
            <ul>
                ...
                <li>Nhân viên trả: {{$data->nhan_vien_tra}}</li>
            ...
            <tbody>
                @foreach ($dataDetail as $idx => $detail)
                    <tr>
                        ...
                        <td>{{number_format($detail->gia_tra_lai)}}{!!!empty($detail->is_percen) ? '%':'<sup>đ</sup>'!!}</td>
                ...
                @endforeach
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($data->giam_gia) }}<sup>đ</sup></td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right">Phí trả hàng: </td>
                        <td>{{ number_format($data->phi_tra_hang) }}<sup>đ</sup></td>
                    </tr>
                    <tr>
