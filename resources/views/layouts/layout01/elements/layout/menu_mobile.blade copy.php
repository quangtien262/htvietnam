    ...
    <div class="sidebar-menu no-scrollbar ">
        ...
        <ul class="nav nav-sidebar nav-vertical nav-uppercase" data-tab="1">
            ...
            <li
                ...
                <a href="https://solar3.maugiaodien.com/" aria-current="page">Trang chủ</a>
            </li>
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-66">
                <a href="https://solar3.maugiaodien.com/about-us/">Về chúng tôi</a>
                <ul class="sub-menu nav-sidebar-ul children sub-menu-mobile">
            ...
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-63"><a
                    href="https://solar3.maugiaodien.com/cua-hang/">Sản phẩm</a></li>
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-740"><a
                    href="https://solar3.maugiaodien.com/du-an-2/">Dự án</a></li>
            <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-67"><a
                    href="https://solar3.maugiaodien.com/tin-tuc/">Tin tức</a></li>
            <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-71"><a
                    href="https://solar3.maugiaodien.com/khuyen-mai/">Khuyến mại</a></li>
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a
                    href="https://solar3.maugiaodien.com/contact-us/">Liên hệ</a></li>
        </ul>
    </div>
</div>
