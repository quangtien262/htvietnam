...
<body
    ...
    <body
        ...
        <script src="/layouts/Aitilen/js/single-product.min.js?ver=7.3.0" id="wc-single-product-js"></script>

        <script src="/layouts/Aitilen/js/flatsome-instant-page.js?ver=1.2.1"></script>
        <script src="/layouts/Aitilen/js/wp-polyfill.min.js?ver=3.15.0""></script>
        <script src=" /layouts/Aitilen/js/hoverIntent.min.js?ver=1.10.2"></script>
