            ...
            <div class="row content-row row-divided row-large row-reverse">
                <div id="product-sidebar" class="col large-4 hide-for-medium shop-sidebar ">
                    ...
                    <aside id="woocommerce_products-2" class="widget woocommerce widget_products">
                        <span class="widget-title shop-sidebar">Phòng nổi bật</span>
                        <div class="is-divider small"></div>
                        <ul class="product_list_widget">
                            @foreach ($productLatest as $pro)
                            @include('layouts.layoutAitilen.elements.product.item_product', [])
                            @endforeach
                        </ul>
                    </aside>
                ...
                <div class="col large-8">
                    <div class="product-main">
                        <div class="row">
                            ...
                            <div class="product-info summary entry-summary product-summary  col-md-6 col-sm-12">
                    ...
                    <div class="product-footer">
                        <div class="woocommerce-tabs wc-tabs-wrapper container tabbed-content">
                            ...
                            <div class="tab-panels">
                                <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content active"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h3 class="title03">Tiện ích có sẵn</h3>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-wand-magic-sparkles"></i>
                                                Điều hòa không khí</p>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-certificate"></i>
                                                Nóng lạnh</p>
                                            <p class="text-left"><i class="icon01 fa-solid fa-bed"></i> Giường
                                                tiêu chuẩn 1m6 x 2m</p>
                                            <p class="text-left"><i class="icon01 fa-solid fa-hdd"></i> Tủ quần
                                                áo 3 cánh, dài 1m2</p>
                                            <p class="text-left"><i class="icon01 fa-solid fa-credit-card"></i>
                                                Bàn bếp</p>
                                            <p class="text-left"><i class="icon01 fa-solid fa-tint"></i> Máy
                                                giặt</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--additional_information panel entry-content "
                                    ...
                                    {{-- {!! $product->content02 !!} --}}
                                        ...
                                        <div class="col-md-6 item-news02">
                                            <h3 class="title03">Phí dịch vụ</h3>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-bolt"></i>
                                                <b>Điện: </b> 3800 / Số điện</p>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-tint"></i>
                                                <b>Nước: </b> 100.000/Người/Tháng </p>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-globe"></i>
                                                <b>Mạng internet: </b> 100.000/Phòng/Tháng </p>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-object-group"></i>
                                                <b>Máy giặt: </b> 70.000/Người/Tháng <br>(<em>Không bắt buộc</em>)</p>
                                            <p class="text-left"><i
                                                    class="icon01 fa-solid fa-shopping-cart"></i> <b>Vệ sinh
                                                    chung: </b>30.000/người/tháng <br>(<em>Bao gồm đổ rác hàng ngày và
                                                    quét dọn ngoài hành lang hàng tuần</em>) </p>
                                            <p class="text-left">
                                                <i class="icon01 fa-solid fa-bolt-lightning"></i>
                                                <b>Điện
                                                    chung: </b>30.000/người/tháng <br>(<em>Bao gồm các tiền điện phía
                                                    ngoài phòng như máy bơm, bóng đèn....</em>) </p>
                                        </div>
                                </div>
                                ...
                                <div id="tabDownloadTDS"
                                    ...
                                    {{ $product->file }}
                                    @else
                                    @include('layouts.layoutAitilen.product.form_download')
                                    @endif
                                </div>
                        ...
                        {{-- <div class="related related-products-wrapper product-section">
                            ...
                            <div class="row has-equal-box-heights equalize-box large-columns-3 medium-columns-3 small-columns-2 row-small slider row-slider slider-nav-reveal slider-nav-push"
                                ...
                                @include('layouts.layoutAitilen.elements.product.item_product_slide', [
                                'product' => $product,
                                ])
                                @endforeach
                            </div>
