...
<body class="product-template-default single single-product postid-808 theme-flatsome woocommerce woocommerce-page woocommerce-no-js lightbox">
    ...
    <div id="wrapper">
                            ...
                            <div class="product-main">
                                <div class="row">
                                    ...
                                    <div class="product-info summary entry-summary col col-fit product-summary">
                                        ...
                                        {{-- share --}}
                                        @include('layouts.layoutAitilen.elements.common.share', ['data' => $product])
                                ...
                                <div class="related related-products-wrapper product-section">
                                    ...
                                    <div class="row has-equal-box-heights equalize-box large-columns-3 medium-columns-3 small-columns-2 row-small slider row-slider slider-nav-reveal slider-nav-push"
                                        ...
                                        @foreach ($product_lienquan as $product)
                                            @include(
                                                'layouts.layoutAitilen.elements.product.item_product_slide',
                                                ['product' => $product]
                                            )
                                        @endforeach
                                    </div>
        ...
        @include('layouts.layoutAitilen.elements.layout.login');
