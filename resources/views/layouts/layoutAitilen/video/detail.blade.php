            ...
            <div class="section-content relative">
                <div class="row align-middle" id="row-1345272763">
                    <div id="col-914956584" class="col medium-6 small-12 large-6">
                        <div class="col-inner">
                            <div class="tieu-de">
                                <h2>{{!empty($menu['menu']) && !empty($menu['menu']['name']) ? $menu['menu']['name'] : ''}}</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="article-inner ">
                        <header class="entry-header">
                            <div class="entry-header-text entry-header-text-top text-left">
                                ...
                                <h1 class="entry-title">{{ $video->name_data }}</h1>
                        ...
                        <div class="entry-content single-page">
                            ...
                            <div class="blog-share text-center">
                                ...
                                {{-- share --}}
                                @include('layouts.layoutAitilen.elements.common.share', ['data' => $video])
                            </div>
                        </div>
                    </div>
                </article>
            ...
            <div class="post-sidebar large-4 col">
                <div id="secondary" class="widget-area " role="complementary">
                    <aside id="flatsome_recent_posts-2" class="widget flatsome_recent_posts">
                        <span class="widget-title "><span>{{__('user.latest_video')}}</span></span>
                        <div class="is-divider small"></div>
                        <ul>
                            @foreach ($videoLatest as $n)
                                @php
