...
import { checkBtnActive } from "./hoa_don_info";
...
const InvoiceList: React.FC = () => {
    ...
    const [mocThoiGian, setMocThoiGian] = useState<MocThoiGianKey>(null as any);


    const [khoangThoiGian, setKhoangThoiGian] = useState(null as any);
