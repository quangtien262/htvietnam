...
const ShiftManagement: React.FC = () => {
    ...
    const fetchCurrentShift = async () => {
        try {
            const response = await axios.get(`/aio/api/spa/ca-lam-viec/current`);
    ...
    const fetchShifts = async () => {
        ...
        try {
            ...
            const response = await axios.get(`/aio/api/spa/ca-lam-viec`, { params });
    ...
    const handleOpenShift = async (values: any) => {
        try {
            const response = await axios.post(`/aio/api/spa/ca-lam-viec/open`, values);
    ...
    const handleCloseShift = async (values: any) => {
        ...
        try {
            const response = await axios.post(`/aio/api/spa/ca-lam-viec/${selectedShift.id}/close`, values);
            if (response.data.success) {
    ...
    const handlePrintHandover = async (shiftId: number) => {
        try {
            const response = await axios.get(`/aio/api/spa/ca-lam-viec/${shiftId}/print`, {
                responseType: 'blob'
            });
