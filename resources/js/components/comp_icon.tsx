...
import {
    ...
    StepBackwardOutlined, CloseCircleOutlined, MinusSquareFilled,
    FastForwardOutlined, CheckCircleOutlined, MinusCircleFilled,
    ...
    RightOutlined, EyeFilled,EyeInvisibleFilled, FileExclamationFilled, RetweetOutlined,
