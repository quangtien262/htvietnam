...
import { numberFormat, numberFormatBycount } from '../../../Function/common';
import { permissionData } from '../../../Function/detail';
...
export default function Dashboard(props) {
                        ...
                        <div className="ant-table-content ant-table-body ant-table-header">
                            ...
                            <table>
                                <thead className="thead-permission">
                                    ...
                                    {permissionData(props.tablesPermission, props.permissionList)}
                            </table>
                        </div>
                    </div>
            </div>;
    ...
    const listItemsLg = props.columns.map((col) => {
        ...
        if(['calendar_cham_cong', 'calendar_lich_hen'].includes(col.type_edit)) {
            return <Calendar value={dayjs(props.data.year + '-' + numberFormatBycount(props.data.month, 2) + '01')}
                            key={col.name}
                            locale='vi_VN'
                    ...
                    <Card type="inner"
                        ...
                        extra={
                            <div>
                                ...
                                <span> </span>
                                <Popconfirm title="Bạn muốn xóa?" onConfirm={cancelDelete} cancelText="Dừng" okText="XÓA">
