...
export const API = {
    ...
    // ===== WHMCS MODULE =====
    // Webhooks Management
    whmcsWebhookList: '/aio/api/whmcs/webhooks',
    whmcsWebhookStore: '/aio/api/whmcs/webhooks',
    whmcsWebhookShow: (id: number) => `/aio/api/whmcs/webhooks/${id}`,
    whmcsWebhookUpdate: (id: number) => `/aio/api/whmcs/webhooks/${id}`,
    whmcsWebhookDelete: (id: number) => `/aio/api/whmcs/webhooks/${id}`,
    whmcsWebhookToggle: (id: number) => `/aio/api/whmcs/webhooks/${id}/toggle`,
    whmcsWebhookTest: (id: number) => `/aio/api/whmcs/webhooks/${id}/test`,
    whmcsWebhookLogs: (id: number) => `/aio/api/whmcs/webhooks/${id}/logs`,
    whmcsWebhookRetry: (id: number, logId: number) => `/aio/api/whmcs/webhooks/${id}/logs/${logId}/retry`,
    whmcsWebhookEvents: '/aio/api/whmcs/webhooks/events',

    // Analytics Dashboard
    whmcsAnalyticsOverview: '/aio/api/whmcs/analytics/overview',
    whmcsAnalyticsRevenue: '/aio/api/whmcs/analytics/revenue',
    whmcsAnalyticsTopCustomers: '/aio/api/whmcs/analytics/top-customers',
    whmcsAnalyticsChurnRate: '/aio/api/whmcs/analytics/churn-rate',
    whmcsAnalyticsPaymentMethods: '/aio/api/whmcs/analytics/payment-methods',
    whmcsAnalyticsCustomerGrowth: '/aio/api/whmcs/analytics/customer-growth',
    whmcsAnalyticsProductPerformance: '/aio/api/whmcs/analytics/product-performance',
    whmcsAnalyticsExport: '/aio/api/whmcs/analytics/export',

    // Currency Management
    whmcsCurrencyList: '/aio/api/whmcs/currencies',
    whmcsCurrencyStore: '/aio/api/whmcs/currencies',
    whmcsCurrencyShow: (id: number) => `/aio/api/whmcs/currencies/${id}`,
    whmcsCurrencyUpdate: (id: number) => `/aio/api/whmcs/currencies/${id}`,
    whmcsCurrencyDelete: (id: number) => `/aio/api/whmcs/currencies/${id}`,
    whmcsCurrencySetBase: (id: number) => `/aio/api/whmcs/currencies/${id}/set-base`,
    whmcsCurrencyUpdateRates: '/aio/api/whmcs/currencies/update-rates',
    whmcsCurrencyConvert: '/aio/api/whmcs/currencies/convert',
    whmcsCurrencyStatistics: '/aio/api/whmcs/currencies/statistics',

    // Tax Management
    whmcsTaxList: '/aio/api/whmcs/tax',
    whmcsTaxStore: '/aio/api/whmcs/tax',
    whmcsTaxShow: (id: number) => `/aio/api/whmcs/tax/${id}`,
    whmcsTaxUpdate: (id: number) => `/aio/api/whmcs/tax/${id}`,
    whmcsTaxDelete: (id: number) => `/aio/api/whmcs/tax/${id}`,
    whmcsTaxStatistics: '/aio/api/whmcs/tax/statistics',
    whmcsTaxReport: '/aio/api/whmcs/tax/report',
    whmcsTaxPreview: '/aio/api/whmcs/tax/preview',
    whmcsTaxAssignProduct: '/aio/api/whmcs/tax/assign-product',
    whmcsTaxRemoveProduct: '/aio/api/whmcs/tax/remove-product',

    // Affiliate System
    whmcsAffiliateList: '/aio/api/whmcs/affiliate',
    whmcsAffiliateStore: '/aio/api/whmcs/affiliate',
    whmcsAffiliateShow: (id: number) => `/aio/api/whmcs/affiliate/${id}`,
    whmcsAffiliateUpdate: (id: number) => `/aio/api/whmcs/affiliate/${id}`,
    whmcsAffiliateDelete: (id: number) => `/aio/api/whmcs/affiliate/${id}`,
    whmcsAffiliateOverview: '/aio/api/whmcs/affiliate/overview',
    whmcsAffiliateTopPerformers: '/aio/api/whmcs/affiliate/top-affiliates',
    whmcsAffiliateStatistics: (id: number) => `/aio/api/whmcs/affiliate/${id}/statistics`,
    whmcsAffiliateReferrals: (id: number) => `/aio/api/whmcs/affiliate/${id}/referrals`,
    whmcsAffiliatePayouts: '/aio/api/whmcs/affiliate/payouts',
    whmcsAffiliateRequestPayout: '/aio/api/whmcs/affiliate/request-payout',
    whmcsAffiliateApprovePayout: (id: number) => `/aio/api/whmcs/affiliate/approve-payout/${id}`,
    whmcsAffiliateRejectPayout: (id: number) => `/aio/api/whmcs/affiliate/reject-payout/${id}`,

    // Knowledge Base
    whmcsKbCategories: '/aio/api/whmcs/kb/categories',
    whmcsKbCategoryStore: '/aio/api/whmcs/kb/categories',
    whmcsKbCategoryUpdate: (id: number) => `/aio/api/whmcs/kb/categories/${id}`,
    whmcsKbCategoryDelete: (id: number) => `/aio/api/whmcs/kb/categories/${id}`,
    whmcsKbArticles: '/aio/api/whmcs/kb/articles',
    whmcsKbArticleStore: '/aio/api/whmcs/kb/articles',
    whmcsKbArticleShow: (id: number) => `/aio/api/whmcs/kb/articles/${id}`,
    whmcsKbArticleUpdate: (id: number) => `/aio/api/whmcs/kb/articles/${id}`,
    whmcsKbArticleDelete: (id: number) => `/aio/api/whmcs/kb/articles/${id}`,
    whmcsKbArticleSearch: '/aio/api/whmcs/kb/articles/search',
    whmcsKbArticlePopular: '/aio/api/whmcs/kb/articles/popular',
    whmcsKbArticleRecent: '/aio/api/whmcs/kb/articles/recent',
    whmcsKbArticleViews: (id: number) => `/aio/api/whmcs/kb/articles/${id}/views`,
    whmcsKbArticleVote: (id: number) => `/aio/api/whmcs/kb/articles/${id}/vote`,
    whmcsKbAttachmentUpload: (articleId: number) => `/aio/api/whmcs/kb/articles/${articleId}/attachments`,
    whmcsKbAttachmentDelete: (id: number) => `/aio/api/whmcs/kb/attachments/${id}`,
    whmcsKbStatistics: '/aio/api/whmcs/kb/statistics',
