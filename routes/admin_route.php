...
Route::post('/bank/account/list', [TaiKhoanNganHangController::class, 'apiList'])->name('api.bank.account.list');
Route::post('/bank/account/add', [TaiKhoanNganHangController::class, 'apiAdd'])->name('api.bank.account.add');
Route::post('/bank/account/update', [TaiKhoanNganHangController::class, 'apiUpdate'])->name('api.bank.account.update');
Route::post('/bank/account/delete', [TaiKhoanNganHangController::class, 'apiDelete'])->name('api.bank.account.delete');
Route::post('/bank/account/update-sort-order', [TaiKhoanNganHangController::class, 'apiUpdateSortOrder'])->name('api.bank.account.update-sort-order');

// Giao dịch ngân hàng
Route::get('/bank/transaction', [GiaoDichNganHangController::class, 'index'])->name('bank.transaction.index');
Route::post('/bank/transaction/list', [GiaoDichNganHangController::class, 'apiList'])->name('api.bank.transaction.list');
Route::post('/bank/transaction/add', [GiaoDichNganHangController::class, 'apiAdd'])->name('api.bank.transaction.add');
Route::post('/bank/transaction/update', [GiaoDichNganHangController::class, 'apiUpdate'])->name('api.bank.transaction.update');
Route::post('/bank/transaction/delete', [GiaoDichNganHangController::class, 'apiDelete'])->name('api.bank.transaction.delete');
Route::post('/bank/transaction/tai-khoan-list', [GiaoDichNganHangController::class, 'apiTaiKhoanList'])->name('api.bank.transaction.tai-khoan-list');
...
Route::post('/erp/dashboard/overview', [ERPDashboardController::class, 'apiOverview'])->name('api.erp.dashboard.overview');
Route::post('/erp/dashboard/cash-flow', [ERPDashboardController::class, 'apiCashFlow'])->name('api.erp.dashboard.cash-flow');
Route::post('/erp/dashboard/cong-no', [ERPDashboardController::class, 'apiCongNo'])->name('api.erp.dashboard.cong-no');
Route::post('/erp/dashboard/chart', [ERPDashboardController::class, 'apiChart'])->name('api.erp.dashboard.chart');
...
Route::post('/hr/cham-cong/store', [ChamCongController::class, 'store'])->name('api.hr.cham-cong.store');
Route::post('/hr/cham-cong/update/{id}', [ChamCongController::class, 'update'])->name('api.hr.cham-cong.update');
Route::post('/hr/cham-cong/approve/{id}', [ChamCongController::class, 'approve'])->name('api.hr.cham-cong.approve');
Route::post('/hr/cham-cong/delete/{id}', [ChamCongController::class, 'destroy'])->name('api.hr.cham-cong.delete');
Route::post('/hr/cham-cong/by-date-range', [ChamCongController::class, 'getByDateRange'])->name('api.hr.cham-cong.by-date-range');

// Bảng lương
Route::get('/hr/bang-luong', [BangLuongController::class, 'index'])->name('hr.bang-luong.index');
Route::post('/hr/bang-luong/tinh-luong', [BangLuongController::class, 'tinhLuong'])->name('api.hr.bang-luong.tinh-luong');
Route::post('/hr/bang-luong/tinh-luong-toan-bo', [BangLuongController::class, 'tinhLuongToanBo'])->name('api.hr.bang-luong.tinh-luong-toan-bo');
Route::post('/hr/bang-luong/approve/{id}', [BangLuongController::class, 'approve'])->name('api.hr.bang-luong.approve');
Route::post('/hr/bang-luong/mark-paid/{id}', [BangLuongController::class, 'markPaid'])->name('api.hr.bang-luong.mark-paid');
Route::get('/api/hr/bang-luong/show/{id}', [BangLuongController::class, 'show'])->name('api.hr.bang-luong.show');
Route::post('/hr/bang-luong/update/{id}', [BangLuongController::class, 'update'])->name('api.hr.bang-luong.update');
Route::post('/hr/bang-luong/delete/{id}', [BangLuongController::class, 'destroy'])->name('api.hr.bang-luong.delete');

// Nghỉ phép
Route::get('/hr/nghi-phep', [NghiPhepController::class, 'index'])->name('hr.nghi-phep.index');
Route::post('/hr/nghi-phep/store', [NghiPhepController::class, 'store'])->name('api.hr.nghi-phep.store');
Route::post('/hr/nghi-phep/approve/{id}', [NghiPhepController::class, 'approve'])->name('api.hr.nghi-phep.approve');
Route::post('/hr/nghi-phep/reject/{id}', [NghiPhepController::class, 'reject'])->name('api.hr.nghi-phep.reject');
Route::post('/hr/nghi-phep/delete/{id}', [NghiPhepController::class, 'destroy'])->name('api.hr.nghi-phep.delete');

// Ca làm việc
Route::get('/api/hr/ca-lam-viec', [CaLamViecController::class, 'index'])->name('api.hr.ca-lam-viec.index');
Route::post('/hr/ca-lam-viec/store', [CaLamViecController::class, 'store'])->name('api.hr.ca-lam-viec.store');
Route::post('/hr/ca-lam-viec/update/{id}', [CaLamViecController::class, 'update'])->name('api.hr.ca-lam-viec.update');
Route::post('/hr/ca-lam-viec/delete/{id}', [CaLamViecController::class, 'destroy'])->name('api.hr.ca-lam-viec.delete');

// Phân ca
Route::get('/api/hr/phan-ca', [CaLamViecController::class, 'phanCaIndex'])->name('api.hr.phan-ca.index');
Route::post('/hr/phan-ca/store', [CaLamViecController::class, 'phanCaStore'])->name('api.hr.phan-ca.store');
Route::post('/hr/phan-ca/delete/{id}', [CaLamViecController::class, 'phanCaDestroy'])->name('api.hr.phan-ca.delete');
...
Route::post('/sales/khach-hang/store', [KhachHangController::class, 'store']);
Route::post('/sales/khach-hang/update/{id}', [KhachHangController::class, 'update']);
Route::post('/sales/khach-hang/delete/{id}', [KhachHangController::class, 'destroy']);

// Đơn hàng
Route::get('/api/sales/don-hang', [DonHangController::class, 'index']);
Route::post('/sales/don-hang/store', [DonHangController::class, 'store']);
Route::post('/sales/don-hang/update/{id}', [DonHangController::class, 'update']);
Route::post('/sales/don-hang/update-status/{id}', [DonHangController::class, 'updateStatus']);
Route::post('/sales/don-hang/cancel/{id}', [DonHangController::class, 'cancel']);
...
Route::post('/sales/phieu-thu/store', [PhieuThuController::class, 'store']);
Route::post('/sales/phieu-thu/approve/{id}', [PhieuThuController::class, 'approve']);

// Khuyến mãi
Route::get('/api/sales/khuyen-mai/chuong-trinh', [KhuyenMaiController::class, 'chuongTrinhIndex']);
Route::post('/sales/khuyen-mai/chuong-trinh/store', [KhuyenMaiController::class, 'chuongTrinhStore']);
Route::get('/api/sales/khuyen-mai/ma-giam-gia', [KhuyenMaiController::class, 'maGiamGiaIndex']);
Route::post('/sales/khuyen-mai/ma-giam-gia/store', [KhuyenMaiController::class, 'maGiamGiaStore']);
Route::post('/sales/khuyen-mai/kiem-tra', [KhuyenMaiController::class, 'kiemTraMaGiamGia']);
...
Route::post('/business/co-hoi/store', [CoHoiKinhDoanhController::class, 'store']);
Route::post('/business/co-hoi/update/{id}', [CoHoiKinhDoanhController::class, 'update']);
Route::post('/business/co-hoi/update-giai-doan/{id}', [CoHoiKinhDoanhController::class, 'updateGiaiDoan']);
Route::post('/business/co-hoi/delete/{id}', [CoHoiKinhDoanhController::class, 'destroy']);
...
Route::post('/business/bao-gia/store', [BaoGiaController::class, 'store']);
Route::post('/business/bao-gia/update/{id}', [BaoGiaController::class, 'update']);
Route::post('/business/bao-gia/update-status/{id}', [BaoGiaController::class, 'updateStatus']);
Route::post('/business/bao-gia/delete/{id}', [BaoGiaController::class, 'destroy']);
...
Route::post('/telesale/data-khach-hang/store', [DataKhachHangController::class, 'store']);
Route::post('/telesale/data-khach-hang/update/{id}', [DataKhachHangController::class, 'update']);
Route::post('/telesale/data-khach-hang/delete/{id}', [DataKhachHangController::class, 'destroy']);
Route::post('/telesale/data-khach-hang/phan-bo', [DataKhachHangController::class, 'phanBo']);
Route::post('/telesale/data-khach-hang/import', [DataKhachHangController::class, 'import']);
...
Route::post('/telesale/cuoc-goi/store', [CuocGoiController::class, 'store']);
...
Route::post('/telesale/don-hang/store', [DonHangTelesaleController::class, 'store']);
Route::post('/telesale/don-hang/update-status/{id}', [DonHangTelesaleController::class, 'updateStatus']);
